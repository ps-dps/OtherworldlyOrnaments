        ...
        "functions": [
            ...
            },
            {
                ...
                "lore": [
                    ...
                    "",
                    [{ "translate": "psdpj11.artifact.size.lore1", "color": "dark_gray", "italic": true }],
                    [{ "translate": "psdpj11.artifact.size.lore2", "color": "dark_gray", "italic": true }],
                    [{ "translate": "psdpj11.artifact.size.lore3", "color": "dark_gray", "italic": true }],
                ]
            }
        ]
    }]}]
